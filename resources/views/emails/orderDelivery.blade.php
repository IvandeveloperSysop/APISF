                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                        <h2 style="color: #a7a8a6;">Hola {{ $userName }},</h2>
                                                                        <h3 style="color: #a7a8a6;">
                                                                            ¡Tu orden ha sido  <b style="color: #3498DB">entregada</b>!
                                                                        </h3>
                                                                        <h3>
                                                                            Gracias por confiar en nosotros
                                                                        </h3>
                                                                        <br>
                                                                        <img src="{{ asset('img/deliveryinHome.jpg') }}" alt="delivery" style="width: 46% !important;">
                                                                    </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                                           ...
                                                                           <tr>
                                                                              <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                                    <h4 style="color: #5f5f5f;">¡Si tienes alguna duda, no dudes en contactarnos! <br>
                                                                                       promociones@desafiosoccerfans.com, (81) 4444 1019.</h4>
                                                                                    <br>
